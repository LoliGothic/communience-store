...
export default new Vuex.Store({
  ...
  mutations: {
    toggleHidden(state, num) {
      if (state.items[num].org_hidden == false) {
        console.log(num, state.items[num].part_hidden)
        state.items[num].part_hidden = true
        console.log(num, state.items[num].part_hidden)
      }
      state.items[num].org_hidden = !state.items[num].org_hidden
    },
    openContents(state, num) {
      console.log(num, state.items[num].part_hidden)
      state.items[num].part_hidden = false
      console.log(num, state.items[num].part_hidden)
    },
  },
});
